...
export const metadata: Metadata = {
  title: "Financieel VvE Beheer",
  description:
    "Transparant financieel VvE beheer: servicekosten, begroting, jaarrekening en reservefonds door VvE Helder.",
};

const taken = [
  "Inning en beheer van servicekosten",
  "Opstellen van de jaarlijkse begroting",
  "Bijhouden van de boekhouding",
  "Opstellen van de jaarrekening",
  "Beheer van het reservefonds",
  "Financiële rapportage aan eigenaren",
  "Debiteurenbeheer bij achterstallige betalingen",
];

export default function FinancieelBeheerPage() {
  return (
    <>
      <section className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-blue-600 font-medium mb-2">Diensten</p>
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Financieel VvE beheer</h1>
          <p className="text-gray-500 max-w-2xl text-lg">
            Transparantie in de financiën is essentieel voor een gezonde VvE.
            Wij zorgen voor een sluitende boekhouding en heldere rapportages.
          </p>
        </div>
      </section>
